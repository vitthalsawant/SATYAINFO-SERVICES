(function ($) {
	...
	/* Sticky Header - keep nav bar visible when scrolling */
	if($('header .header-sticky').length){
		...
		$(window).on("scroll", function() {
			...
			setHeaderHeight();
			/* Stick header after small scroll; never hide so it stays visible */
			$("header .header-sticky").toggleClass("active", (fromTop > 80));
		});
